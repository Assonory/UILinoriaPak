...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"000f1e","AccentColor":"ffff00","BackgroundColor":"050514","OutlineColor":"0a1e28"}') },
	...
	function ThemeManager:CreateGroupBox(tab)
		...
		return tab:AddLeftGroupbox('Menu')
	end
